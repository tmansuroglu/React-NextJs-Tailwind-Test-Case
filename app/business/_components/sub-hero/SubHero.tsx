...
export function SubHero() {
  return (
    <section
      className="relative container mx-auto px-4 pt-10 pb-6"
      role="region"
    ...
    >
      ...
      <div
        role="group"
        className="grid gap-6 lg:gap-12 xl:grid-cols-2 xl:justify-between"
      >
        <Image
          src="/phone.webp"
          ...
          width={976}
          height={1238}
          className="xl:order-2 object-contain max-h-[552px] xl:max-h-[684px] 2xl:max-h-[552px]"
          loading="lazy"
        />
        <div className="flex gap-6 flex-col xl:order-1">
          <p className="font-md xl:font-md-plus text-brand-secondary-black">
          ...
          <div>
            <p className="text-brand-primary-orange font-lg xl:font-xl-plus">
          ...
          <p className="font-sm-bold text-brand-secondary-black">
            It&apos;s as simple as:
          </p>
          <ol className="" aria-label="PayLater process steps">
            <li role="listitem">
              <Step
                data-testid="step-1"
                number={1}
